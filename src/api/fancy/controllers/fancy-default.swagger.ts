...
export const ApiFancyDefault: ApiOperator<keyof FancyController> = {
        ...
        [
          {
            ...
            path: `${FancyController.path}?page=a&pageSize=5`
          },
          {
            message: [
            ...
            path: `${FancyController.path}?page=1&pageSize=a`
          },
          {
            message: ['name must be shorter than or equal to 50 characters'],
            description: 'name 조건에 해당하지 않는 경우',
            path: `${FancyController.path}?name=asdfasdfasdfasdfasdfasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaa`
          },
          {
            message: ['status must be one of the following values: ACTIVE, INACTIVE'],
            description: 'status 조건에 해당하지 않는 경우',
            path: `${FancyController.path}?status=asd`
          },
          {
            message: [
            ...
            path: `${FancyController.path}?optionId=a&optionId=a&optionId=a&optionId=a&optionId=a&optionId=a`
          },
          {
            message: [
            ...
            path: `${FancyController.path}?subOptionId=a&subOptionId=a&subOptionId=a&subOptionId=a&subOptionId=a&subOptionId=a`
          },
          {
            message: [
            ...
            path: `${FancyController.path}?lookId=a&lookId=a&lookId=a&lookId=a&lookId=a&lookId=a`
          },
          {
            message: [
            ...
            path: `${FancyController.path}?tagId=a&tagId=a&tagId=a&tagId=a&tagId=a&tagId=a`
          },
          {
            message: [
