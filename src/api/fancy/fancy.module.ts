...
import { FANCY_REPOSITORY_DI_TOKEN, FANCY_SERVICE_DI_TOKEN } from '@src/common/constants/di.tokens';

@Module({
  imports: [],
  controllers: [FancyAdminController, FancyController],
  providers: [
    { provide: FANCY_SERVICE_DI_TOKEN, useClass: FancyService },
    { provide: FANCY_REPOSITORY_DI_TOKEN, useClass: FancyRepository }
  ]
})
